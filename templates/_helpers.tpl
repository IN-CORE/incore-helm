...
Common labels
*/}}
{{- define "incore.labels" -}}
helm.sh/chart: {{ include "incore.chart" . }}
{{ include "incore.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "incore.selectorLabels" -}}
app.kubernetes.io/name: {{ include "incore.name" . }}
...
*/}}
{{- define "incore.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "incore.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
{{- printf "mongodb://root:%s@%s-mongodb:27017/%s?maxpoolsize=100&authSource=admin" .Values.mongodb.auth.rootPassword (include "incore.fullname" .) "@DB@" }}
{{- end }}
